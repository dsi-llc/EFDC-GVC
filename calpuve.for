...
C----------------------------------------------------------------------C
C
C **  TESTED EVERGLADES WETLANDS VERSION OF CALPUV5
C
C**********************************************************************C
C
C ** SUBROUTINE CALPUVE CALCULATES THE EXTERNAL SOLUTION FOR P, UHDYE,
C ** AND VHDXE, FOR FREE SURFACE FLOWS WITH PROVISIONS FOR WETTING
C ** AND DRYING OF CELLS THIS IS EVERGLADE HYDRODYNAMIC MODEL VERSION
C
C**********************************************************************C
C
      INCLUDE 'EFDC.PAR'
...
C
 4000 CONTINUE
      ...
      IF(ISLOG.GE.1.AND.MDCHH.GE.1) WRITE(8,8000)MDCHITR,QCHERM
C
 8000 FORMAT(' MDCHITR = ',I5,'  QCHERM = ',E12.4)
