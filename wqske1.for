...
C
      INCLUDE 'EFDC.PAR'
      INCLUDE 'EFDC.CMN'
      DIMENSION WQDOS(LCMWQ),WQI0BOT(LCMWQ),O2WQ(LCMWQ),WQOBTOT(LCMWQ),
     &        RNH4WQ(LCMWQ),PO4DWQ(LCMWQ),RNH4NO3(LCMWQ),RNO3WQ(LCMWQ)
      DIMENSION DELKC(KCM)
C
C**********************************************************************C
C
C       LTEST=51
C       OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C       IVAL=MOD(N,36)
C       IIITEST=0
C       IF(IVAL.EQ.0)THEN
C         IIITEST=1
...
C MRM +++++++++ ADDED BY M. MORTON 08/05/98
          ...
          WRITE(1,911) TIMTMP, L, IL(L), JL(L), K, TWQ(L),TEM(L,K)
911       FORMAT(/,'ERROR!! INVALID WATER TEMPERATURE, SUB WQSKE',/,
     +     'TIME, L, I, J, K, TWQ(L),TEM(L,K) = ', F10.5, 4I4, 2F10.4)
          CLOSE(1)
...
C
C      OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C       WRITE(1,*)'END ALGAE PARAMETERS'
C      CLOSE(1)
C
C----------------------------------------------------------------------C
C
...
C
C      OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C       WRITE(1,*)'END ORGANIC CARBON PARAMETERS'
C      CLOSE(1)
C
C----------------------------------------------------------------------C
C
...
C
C      OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C       WRITE(1,*)'END ORGANIC PHOSPHOROUS PARAMETERS'
C      CLOSE(1)
C
C----------------------------------------------------------------------C
C
...
C
C      OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C       WRITE(1,*)'END ORTHOPOSPHATE PARAMETERS'
C      CLOSE(1)
C
C----------------------------------------------------------------------C
C
...
C
C      OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C       WRITE(1,*)'END ORGANIC NITROGEN PARAMETERS'
C      CLOSE(1)
C
C----------------------------------------------------------------------C
C
...
C          WRITE(1,1414)K,WQNIT(L),O2WQ(L),WQTDNIT(IWQT(L)),WQKHNDO,
C     &    WQKHNN,RNH4WQ(L)
C        ENDIF
C
       ENDDO
C
C      OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C       WRITE(1,*)'END AMONIA PARAMETERS'
C      CLOSE(1)
C
C----------------------------------------------------------------------C
C
...
C
C      OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C       WRITE(1,*)'END COD AND OXY PARAMETERS'
C      CLOSE(1)
C
C----------------------------------------------------------------------C
C
...
C MRM  ADD WET ATMOSPHERIC DEPOSITION:
          WQR20(L) = WQR20(L) + DELKC(K)*(WQATML(L,KC,20)*VOLWQ(L))
...
C DEFINITIONS              ATM WET DEP      VOLUMN
        WQR1C = WQR1C + DELKC(K)*(WQATML(L,KC,1)*VOLWQ(L))
C
...
C DEFINITIONS              ATM WET DEP      VOLUMN
        WQR2D = WQR2D + DELKC(K)*(WQATML(L,KC,2)*VOLWQ(L))
C
...
C DEFINITIONS              ATM WET DEP      VOLUMN
        WQR3G = WQR3G + DELKC(K)*(WQATML(L,KC,3)*VOLWQ(L))
C
...
C
C DEFINITIONS              ATM WET DEP      VOLUMN
        WQR4 = WQR4 + DELKC(K)*(WQATML(L,KC,4)*VOLWQ(L))
C
...
C
C DEFINITIONS              ATM WET DEP      VOLUMN
        WQR5 = WQR5 + DELKC(K)*(WQATML(L,KC,5)*VOLWQ(L))
C
...
C
C       OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C        WRITE(1,*)L,WQDENIT(L)
C       CLOSE(1)
C       OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C        WRITE(1,*)L,WQKHR(L)
C       CLOSE(1)
C       OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C        WRITE(1,*)L,WQFCDC,CFCDCWQ,WQKHRC,O2WQ(L)
C       CLOSE(1)
C       OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C        WRITE(1,*)L,WQFCDD,CFCDDWQ,WQKHRD,O2WQ(L)
C       CLOSE(1)
C       OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C        WRITE(1,*)L,WQFCDG,CFCDGWQ,WQKHRG,O2WQ(L)
C       CLOSE(1)
C       OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C        WRITE(1,*)L,WQBMC(L),WQFCDP,WQPRC(L),WQVO(L,K,1)
C       CLOSE(1)
C       OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C        WRITE(1,*)L,WQBMD(L),WQFCDP,WQPRD(L),WQVO(L,K,2)
C       CLOSE(1)
C       OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C       CLOSE(1)
C       WRITE(1,*)L,WQBMG(L),WQFCDP,WQPRG(L),WQVO(L,K,3)
C       CLOSE(1)
C       OPEN(1,FILE='WQSKE1.DIA',POSITION='APPEND')
C        WRITE(1,*)L,WQWDSL(L,K,6),WQWPSL(L,K,6),WQATML(L,KC,6),VOLWQ(L)
C       CLOSE(1)
C
        ...
        WQA6 = ( WQA6C*WQBMC(L) + WQFCDP*WQPRC(L) )*WQVO(L,K,1)
     *       + ( WQA6D*WQBMD(L) + WQFCDP*WQPRD(L) )*WQVO(L,K,2)
     *       + ( WQA6G*WQBMG(L) + WQFCDP*WQPRG(L) )*WQVO(L,K,3)
C
        IF(IDNOTRVA.GT.0.AND.K.EQ.1)THEN
...
C
C DEFINITIONS              ATM WET DEP      VOLUMN
        WQR6 = WQR6 + DELKC(K)*(WQATML(L,KC,6)*VOLWQ(L))
C
CJH7/22        WQRR(L) = WQVO(L,K,6) + DTWQ*WQR6 + DTWQO2*( WQA6 + WQKRPC(L)*
CJH7/22     *    WQVO(L,K,4) + WQKLPC(L)*WQVO(L,K,5) + WQD6*WQVO(L,K,6) )
CCJH7/22
...
C
C DEFINITIONS              ATM WET DEP      VOLUMN
        WQR7 = WQR7 + DELKC(K)*(WQATML(L,KC,7)*VOLWQ(L))
C
...
C
C DEFINITIONS              ATM WET DEP      VOLUMN
        WQR8 = WQR8 + DELKC(K)*(WQATML(L,KC,8)*VOLWQ(L))
C
...
C
C DEFINITIONS              ATM WET DEP      VOLUMN
        WQR9 = WQR9 + DELKC(K)*(WQATML(L,KC,9)*VOLWQ(L))
C
CJH720        WQRR(L) = WQVO(L,K,9) + DTWQ*WQR9 + DTWQO2*(WQA9 + WQKRPP(L)*
CJH720     *   WQVO(L,K,7) + WQKLPP(L)*WQVO(L,K,8) - WQKDOP(L)*WQVO(L,K,9))
CCJH720
...
C
C DEFINITIONS              ATM WET DEP      VOLUMN
        WQRR(L) = WQRR(L) + DELKC(K)*(WQATML(L,KC,10)*VOLWQ(L))
C
       ENDDO
C
       IF(K.EQ.1)THEN
...
C
       DO L=2,LA
C
CJH720        WQRR(L) = WQVO(L,K,10) + DTWQ*WQRR(L) + DTWQO2*( WQKK(L)
CJH720     *    + WQKDOP(L)*WQVO(L,K,9) + WQH10(L)*WQVO(L,K,10) )
CCJH720
...
C
C DEFINITIONS              ATM WET DEP      VOLUMN
         WQR11 = WQR11 + DELKC(K)*(WQATML(L,KC,11)*VOLWQ(L))
C
...
C
C DEFINITIONS              ATM WET DEP      VOLUMN
         WQR12 = WQR12 + DELKC(K)*(WQATML(L,KC,12)*VOLWQ(L))
C
...
C
C DEFINITIONS              ATM WET DEP      VOLUMN
        WQR13 = WQR13 + DELKC(K)*(WQATML(L,KC,13)*VOLWQ(L))
C
CJH720        WQRR(L) = WQVO(L,K,13) + DTWQ*WQR13 + DTWQO2*( WQA13
CJH720     *     + WQKRPN(L)*WQVO(L,K,11) + WQKLPN(L)*WQVO(L,K,12)
CJH720     *     - WQKDON(L)*WQVO(L,K,13) )
CCJH720
...
C
C DEFINITIONS              ATM WET DEP      VOLUMN
        WQRR(L) = WQRR(L) + DELKC(K)*(WQATML(L,KC,14)*VOLWQ(L))
C
       ENDDO
C
       IF(K.EQ.1)THEN
...
C
     ...
     *      - WQPNM(L)*WQPM(L))*WQANCM*WQVO(L,K,IDNOTRVA)
        ENDIF
C
CJH720        WQRR(L) = WQVO(L,K,14) + DTWQ*WQRR(L) + DTWQO2*( WQA14
CJH720     *     + WQKDON(L)*WQVO(L,K,13) - WQNIT(L)*WQVO(L,K,14) )
CCJH720
        WQRR(L) = WQVO(L,K,14) + DTWQ*WQRR(L) + DTWQO2*( WQA14
     *     + WQKRPN(L)*WQVO(L,K,11)
...
C
C DEFINITIONS              ATM WET DEP      VOLUMN
        WQRR(L) = WQRR(L) + DELKC(K)*(WQATML(L,KC,15)*VOLWQ(L))
C
       ENDDO
C
       IF(K.EQ.1)THEN
...
C
C DEFINITIONS              ATM WET DEP      VOLUMN
          WQR16 = WQR16 + DELKC(K)*(WQATML(L,KC,16)*VOLWQ(L))
C
...
C
C DEFINITIONS              ATM WET DEP      VOLUMN
        WQRR(L) = WQRR(L) + DELKC(K)*(WQATML(L,KC,18)*VOLWQ(L))
C
       ENDDO
C
       IF(K.EQ.1)THEN
...
C
C DEFINITIONS              ATM WET DEP      VOLUMN
        WQRR(L) = WQRR(L) + DELKC(K)*(WQATML(L,KC,19)*VOLWQ(L))
C
       ENDDO
C
       IF(K.EQ.KC)THEN
...
C
       IF(K.EQ.1)THEN
         DO L=2,LA
           ...
           WQRR(L) = WQRR(L) + TEMFAC*WQBFO2(L)*DZWQ(L)
           XDOSOD(L,K) = XDOSOD(L,K) + TEMFAC*WQBFO2(L)*DTWQ
           XDOALL(L,K) = XDOALL(L,K) + TEMFAC*WQBFO2(L)*DTWQ
         ENDDO
       ENDIF
C
       DO L=2,LA
...
C J.S.
C
CJH720         WQRR(L) = WQVO(L,K,19) + DTWQ*WQRR(L) + DTWQO2*( WQA19
CJH720     *     - WQAOCR*WQKHR(L)*WQVO(L,K,6) - WQAONT*WQNIT(L)*WQVO(L,K,14)
CJH720     *     + WQP19(L)*WQVO(L,K,19) ) + WQO18(L)*WQVO(L,K,18)
CCJH720
         WQRR(L) = WQVO(L,K,19) + DTWQ*WQRR(L) + DTWQO2*( WQA19
     *     - WQAOCR*WQKRPC(L)*WQVO(L,K,4)
...
C
C        IF(L.EQ.LTEST.AND.IIITEST.EQ.1)THEN
C          WRITE(1,1414)K,WQVO(L,K,19),WQRR(L),WQA19,WQKHR(L),
