...
C CHLM = MACROALGAE BIOMASS IN UG/L:
          ...
          IF(IWQSRP.EQ.1)THEN
            ...
            PO4DWQSUM(LL,K) = PO4DWQSUM(LL,K) + PO4DWQ
...
C
     ...
     +      XDT, IXDT, NPARM, NCELLS, NLAYERS
          NDUM=NDUM
          XDUM=XDUM
          WRITE(2, REC=1) NREC, TBEGIN, TIMTMP,
     +      XDT, IXDT, NPARM, NCELLS, NLAYERS
...
C
     ...
     +     FORM='UNFORMATTED', STATUS='UNKNOWN', RECL=MAXRECL3)
          ...
          READ(2, REC=1) NDUM, XDUM, XDUM,
     +      XDT, IXDT, NPARM, NCELLS, NLAYERS
          WRITE(2, REC=1) NREC3, TBEGIN, TIMTMP,
     +      XDT, IXDT, NPARM, NCELLS, NLAYERS
...
C
     ...
     +     FORM='UNFORMATTED', STATUS='UNKNOWN', RECL=MAXRECL2)
          ...
          READ(2, REC=1) NDUM, XDUM, XDUM,
     +      XDT, IXDT, NPARM, NCELLS, NLAYERS
          WRITE(2, REC=1) NREC2, TBEGIN, TIMTMP,
     +      XDT, IXDT, NPARM, NCELLS, NLAYERS
