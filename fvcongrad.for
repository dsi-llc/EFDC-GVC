...
C **  IT IS DESIGNED TO USE THE VECTORIZABLE SUBROUTINE FVMULAD2
C **  WHICH IS SIMILAR TO THE ALTIVEC VECTOR SUBROUTINE CVMULAD2
C
...
C**********************************************************************C
C
C ** HAMRICK'S F VECTOR SUBROUTINES MUST BE LINKED WITH EXECUTABLE
C
C     FVMULAD2(LCM,LC,A,B,C,D) => [A]=[B]+[C]*[D]
C
...
C
      ...
      ENDIF
C
      CALL FVMULAD2(LCM,LC,RTMP,RCG,CCC,P)
C
      ...
      ENDIF
C
      CALL FVMULAD2(LCM,LC,RCG,RTMP,CCS,PS)
C
      ...
      ENDIF
C
      CALL FVMULAD2(LCM,LC,RTMP,RCG,CCW,PW)
C
      ...
      ENDIF
C
      CALL FVMULAD2(LCM,LC,RCG,RTMP,CCE,PE)
C
      ...
      ENDIF
C
      CALL FVMULAD2(LCM,LC,RTMP,RCG,CCN,PN)
C
C     DO L=2,LA
C       RCG(L)=-RCG(L)
...
C
      ...
      ENDIF
C
      CALL FVMULAD2(LCM,LC,PCG,RNULL,RCG,CCCI)
C
...
C     ENDDO
C
      CALL FVMULAD2(LCM,LC,RTMP,RNULL,RCG,CCCI)
      CALL FVMULAD2(LCM,LC,RTMP1,RNULL,RCG,RTMP)
C
...
C     ENDDO
C
      CALL FVMULAD2(LCM,LC,APCG,RNULL,CCC,PCG)
C
      IF(IVECDIG.EQ.1)WRITE(8,*)'VCONGRAD 9'
C
      CALL FVMULAD2(LCM,LC,RTMP,APCG,CCS,PCGS)
C
      IF(IVECDIG.EQ.1)WRITE(8,*)'VCONGRAD 10'
C
      CALL FVMULAD2(LCM,LC,APCG,RTMP,CCW,PCGW)
C
      IF(IVECDIG.EQ.1)WRITE(8,*)'VCONGRAD 11'
C
      CALL FVMULAD2(LCM,LC,RTMP,APCG,CCE,PCGE)
C
      IF(IVECDIG.EQ.1)WRITE(8,*)'VCONGRAD 12'
C
      CALL FVMULAD2(LCM,LC,APCG,RTMP,CCN,PCGN)
C
...
C     END DO
C
      CALL FVMULAD2(LCM,LC,RTMP,RNULL,APCG,PCG)
C
...
C
      ...
      END DO
C
      CALL FVMULAD2(LCM,LC,P,RTMP1,RA4,PCG)
C
...
C
      ...
      END DO
C
      CALL FVMULAD2(LCM,LC,RCG,RTMP,RA4,APCG)
C
...
C
      CALL FVMULAD2(LCM,LC,RTMP1,RNULL,RTMP,RCG)
C
...
C
      ...
      ENDDO
C
      CALL FVMULAD2(LCM,LC,RTMP,RNULL,PCG,RA4)
C
      IF(IVECDIG.EQ.1)WRITE(8,*)'VCONGRAD 20'
C
      CALL FVMULAD2(LCM,LC,PCG,RTMP,CCCI,RCG)
C
